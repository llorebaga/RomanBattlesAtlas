...
export const timelineMilestones: TimelineMilestone[] = [
  ...
  { id: "carthage-destroyed", year: -146, label: "Carthage destroyed", note: "Carthage and Corinth are sacked in the same year, and the atlas’s mapped period ends here.", mapped: true, focus: { location: [10.32, 36.85], zoom: 5.4 } },
