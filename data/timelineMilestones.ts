...
export const timelineMilestones: TimelineMilestone[] = [
  ...
  { id: "alesia", year: -52, label: "Alesia", note: "Caesar besieges a hilltop and a relieving army at once, with two walls facing opposite ways, and Gaul is finished.", mapped: true, focus: { location: [4.5, 47.54], zoom: 5.6 } },
  { id: "caesar-civil-war", year: -49, label: "Caesar's civil war", note: "The Rubicon, Pharsalus, and the end of the Republic in practice.", mapped: true, focus: { location: [22.38, 39.29], zoom: 5.0 } },
  { id: "ides-of-march", year: -44, label: "The Ides of March", note: "Sixty senators kill Caesar believing it restores the Republic. The atlas ends here; what follows is a different constitution.", mapped: true, focus: { location: [12.48, 41.9], zoom: 6.0 } },
